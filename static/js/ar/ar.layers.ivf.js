...
//    imagedata: [],
   ...
   initialize: function()
      ...
      this.control = ar.layercontrol.create(this, "ivf");
//       this.layer = L.canvasOverlay("", [[-84.89209, -360], [84.89209, 0]], {opacity: 1, image_smoothing: false});
   ...
   save: function()
      {
      window.localStorage.setItem("ar_ivf_visible", this.visible);
      window.localStorage.setItem("ar_ivf_opacity", this.opacity);
      window.localStorage.setItem("ar_ivf_field_mode", this.field);
      },

   load: function()
      {
      if(ar.map.ready() && (window.localStorage.getItem("ar_ivf_visible") === "false"))
         this.control.trigger("top_click");

      if(window.localStorage.getItem("ar_ivf_opacity"))
         {
         var value = parseFloat(window.localStorage.getItem("ar_ivf_opacity"));
         this.setOpacity(value);
         }

      if(localStorage.getItem("ar_ivf_field_mode"))
         $("#ar_field_" + localStorage.getItem("ar_ivf_field_mode")).trigger("mousedown");
      },
