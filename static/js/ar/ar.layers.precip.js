...
ar.layers.precip = 
   ...
   refresh: function()
      {
         ...
         console.log("ar.layers.precip.refresh activeURL = " + activeURL); // Nhi
   ...
   updateGeojsonPlot: function(date, time)
     ...
     // if(time === "000")
       //  time = "001";
      console.log("updateGeojsonPlot - date = " + date + "time = " + time); // Nhi ts.substr(0,4)
      if(date === "")
         date = ar.projects.maxAvailableDate;

      currUrl = "geojson/stations/" + date + "/prcp_type_obs_" + date + "_" + time + ".geojson"; // ex: prcp_type_obs_20230619_023.geojson
      if( date > ar.projects.maxAvailableDate)
         currUrl = "geojson/bk.geojson";
   ...
   showPlot: function(target)
      ...
      var url = ar.projects.getActiveGeoJSONURL();
