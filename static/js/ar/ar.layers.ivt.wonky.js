...
ar.layers.ivt = 
   ...
   setField: function(field)
      ...
      if(this.field !== field)
         ...
         if(ar.projects.getActiveModel())
            {
            var modelName = ar.projects.getActiveModel().id.toUpperCase();
            $("#time_label_container").prop("title", "Timestamp of displayed IVT calculated from " + modelName);
            $("#time_label_container").find("legend").text(modelName + " IVT");
            }
         }
      },
